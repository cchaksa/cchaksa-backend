...
- [ ] 학과 공개 검색 API 컨트롤러 테스트를 RED 상태로 추가한다.
- [ ] 학과 공개 검색 서비스 테스트를 RED 상태로 추가한다.
- [ ] 학과 공개 검색 API를 구현한다.
- [ ] 현재 인증 계정 초기화 API 테스트를 RED 상태로 추가한다.
- [ ] 현재 인증 계정 초기화 API를 구현한다.
- [ ] 현재 인증 계정 테스트 강의 생성 API 테스트를 RED 상태로 추가한다.
- [ ] 현재 인증 계정 테스트 강의 생성 API를 구현한다.
- [ ] Swagger와 정적 OpenAPI 문서를 8개 API 기준으로 갱신한다.
